...
## 2. Phase 5 以降でのFigma Makeの使い方

各Phaseの実装開始前に以下の手順を踏む。
...
| Phase | Figma作成対象画面 | 実装対象画面 | Figma作成タイミング |
|---|---|---|---|
| Phase 5 | Create Start, Photo Selection, Create Preview | SCR-CREATE-001, SCR-CREATE-002 | Phase 5 開始前 |
| Phase 6 | Upload Progress, Processing | SCR-UPLOAD-001, SCR-UPLOAD-002 | Phase 6 開始前 |
| Phase 7 | Upload Progress 詳細, 再試行 | SCR-UPLOAD-001 詳細, SCR-ERR-003 | Phase 7 開始前 |
| Phase 8 | Map View, Note Detail 地図セクション | SCR-MAP-001 | Phase 8 開始前 |
| Phase 9 | AI Preview, Title Edit, Diary Edit, AI Error | SCR-AI-001〜004, SCR-ERR-004 | Phase 9 開始前 |
| Phase 10 | Note Detail 完成版, Note Edit, Photo List | SCR-NOTE-001〜004 | Phase 10 開始前 |
| Phase 11 | Members, Invite, Permissions | SCR-SHARE-001〜005 | Phase 11 開始前 |
| Phase 12 | Share Card Settings, Preview, Share Sheet | SCR-CARD-001〜004 | Phase 12 開始前 |
| Phase 13 | Calendar, Search, On This Day | SCR-MAP-002〜004 | Phase 13 開始前 |
| Phase 14 | Settings 詳細, 権限説明, Privacy, Terms | SCR-SET-002〜005 | Phase 14 開始前 |
...
- [ ] Create フローの状態管理（タイトル / メモ / 写真）の設計を決める
- [ ] Phase 5 の Figma Make 生成を完了させる（Create Start / Photo Selection / Preview）
