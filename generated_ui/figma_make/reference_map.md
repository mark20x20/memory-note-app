...
| SCR-NOTE-001 | ノート詳細 | `/(app)/notes/[noteId]` | `app/(app)/notes/[noteId].tsx` | ✅ Phase 9 更新済み（AiDiarySection 統合・onSnapshot 切り替え・AI日記4状態 UI） | Phase 7〜9 | ○ | **A** | phase9_ai_generation/ | 編集UIは Phase 10 |
